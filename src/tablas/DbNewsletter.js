...
export default function DbNewsletter(props) {
  ...
  <div className="paginacion">
    ...
    ):<a href={"/dbNewsletter"+"/"+(Number(p)-1)}><i  className="fa fa-chevron-left "></i></a>}
    
       <p>{p}</p>
      
       {(Number(p) == Ind.length)?(
       <p className="disabled"><i  className="fa fa-chevron-right"></i></p>
    ):<a href={"/dbNewsletter"+"/"+(Number(p)+1)}><i  className="fa fa-chevron-right "></i></a>}
  </div>
